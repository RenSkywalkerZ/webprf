  ...
  const events = [
    {
      ...
      description:
        "Kompetisi tingkat SMA/MA dan Perguruan Tinggi untuk menguji kemampuan pengetahuan dan keterampilan analitis dalam bidang fisika.",
      category: "SMA/MA dan Perguruan Tinggi",
    ...
    },
    {
      ...
      description: "Kompetisi penulisan karya ilmiah dalam bidang fisika tingkat SMP/MT hingga Perguruan Tinggi.",
    ...
    },
    {
      ...
      description:
        "Kompetisi proyek sains tingkat SMP/MT dan SMA/MA yang mengatasi masalah berkelanjutan melalui pendekatan fisika.",
    ...
    },
    {
      ...
      description: "Ajang perlombaan dalam melakukan berbagai eksperimen fisika tingkat SMP/MT dan SMA/MA.",
      category: "SMP/MT dan SMA/MA",
    ...
    },
    {
      ...
      description:
        "Kompetisi merancang dan meluncurkan roket air dengan prinsip-prinsip aerodinamika tingkat SMP/MT dan SMA/MA.",
      category: "SMP/MT dan SMA/MA",
    ...
    },
    {
      ...
      title: "Cerdas Cermat",
      description:
        "Kompetisi cerdas cermat fisika yang menguji kecepatan dan ketepatan dalam menjawab soal-soal fisika dan sains untuk tingkat SD/MI dan SMP/MT.",
      category: "SD/MI dan SMP/MT",
    ...
    },
    {
      ...
      title: "Lomba Robotik",
      description:
        "Kompetisi robotik untuk pelajar TK hingga SMA/MA yang menggabungkan prinsip fisika dan teknologi modern dalam perancangan, perakitan, dan pemrograman robot.",
      category: "TK/sederajat - SMA/MA",
